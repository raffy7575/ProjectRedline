...
const DEFAULT_METERS_PER_PROGRESS_STEP = 1.35;
let METERS_PER_PROGRESS_STEP = DEFAULT_METERS_PER_PROGRESS_STEP;
...
function setMetersPerProgressStep(value) {
	if (!Number.isFinite(value) || value <= 0) return;
	METERS_PER_PROGRESS_STEP = value;
}

function resetMetersPerProgressStep() {
	METERS_PER_PROGRESS_STEP = DEFAULT_METERS_PER_PROGRESS_STEP;
}
